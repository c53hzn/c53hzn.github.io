        	...
        	if(numberedMatrix[this.parentNode.rowIndex][this.cellIndex].mine == true){
        		for(var mm = 0; mm < tds.length; mm++){
        			if(numberedMatrix[Math.floor(mm / mineLineLen)][mm % mineLineLen].mine){
        				...
        				tds[mm].innerHTML = "<div style='text-align: center;'>O</div>";
        			}
        		}
	            ...
	            switch(innerNum){
	            	...
	            	break;
	            	case 1:
	            	this.innerHTML = "<div style='text-align: center; color: blue; font-weight: bold;'>1</div>";
	            	break;
	            	case 2:
	            	this.innerHTML = "<div style='text-align: center; color: green; font-weight: bold;'>2</div>";
	            	break;
	            	case 3:
	            	this.innerHTML = "<div style='text-align: center; color: red; font-weight: bold;'>3</div>";
	            	break;
	            	case 4:
	            	this.innerHTML = "<div style='text-align: center; color: darkblue; font-weight: bold;'>4</div>";
	            	break;
	            	case 5:
	            	this.innerHTML = "<div style='text-align: center; color: darkred; font-weight: bold;'>5</div>";
	            	break;
	            	case 6:
	            	this.innerHTML = "<div style='text-align: center; color: lightblue; font-weight: bold;'>6</div>";
	            	break;
	            	case 7:
	            	this.innerHTML = "<div style='text-align: center; color: black; font-weight: bold;'>7</div>";
	            	break;
	            	case 8:
	            	this.innerHTML = "<div style='text-align: center; color: rgb(128, 128, 128); font-weight: bold;'>8</div>";
	            	break;
	            }
        	}
        }
