...
当我已经有了github给的二级域名以后，不禁心想，如果我还可以有一个自己的域名，像什么t*\*b**.com啦，q*.com啦，b*\*d*.com啦，要是我也有一个这样的域名指向我的博客那该多好啊。
...
假设你没有用github之类的免费托管服务，而是在阿里云上买空间，那么阿里云会要求你一定要使用备案过的域名，备案的步骤看得人眼晕，而且每一步都是奔着查水表来的。

既然github没有这些查水表的要求，我还是另外看看别的服务吧。
...
域名买好了，得绑定到houzhenni.github.io这个repo上才行。
